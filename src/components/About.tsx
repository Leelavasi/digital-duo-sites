      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between">
          <div className="flex justify-center mb-8">
            {/* <img src="/me.JPG" /> */}
            <Avatar className="w-72 h-92 ring-2 ring-blue-400/30 hover:ring-blue-400/50 transition-all duration-300">
              <AvatarImage 
                src="/me.JPG" 
                alt="Profile picture"
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <Card className="bg-white/10 backdrop-blur-sm border-gray-700 hover:bg-white/20 transition-all duration-300 hover:scale-105">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-300">
                Generative design , Optimization leveraging its computational capabilities.
              </p>
            </CardContent>
          </Card>
